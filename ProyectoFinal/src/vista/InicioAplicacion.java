...
public class InicioAplicacion extends javax.swing.JFrame {
    ...
    public InicioAplicacion() {
        initComponents();
        // El siguiente método que también pertenece al JFrame
        // Centra la ventana
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(0, 118, 162));
        jPanel1.setForeground(new java.awt.Color(0, 118, 162));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Le ordenamos al JFrame que se llama AdministraciónAplicación
        // Que se muestre
        AdministrarAplicacion admin=new AdministrarAplicacion();
        admin.setVisible(true); // Mostrar JFrame
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        test.setVisible(true); // Mostrar JFrame
